...
// Dati dinamici per il componente About


const About = () => {
  const aboutData = {
    title: "Collettivo Piano A",
    description: [
      t("about.description1"),
      t("about.description2"),
    ],
    mainImage: "/img/imgss/7.png",
    bgImage: "/img/imgss/8.png",
    discordLink: "https://instagram.com",
  };
  return (
    <section id="about">
      <div className="fn_cs_about">
        <div className="left_part">
          <div className="img">
            <div className="img_in" style={{ backgroundImage: `url(${aboutData.mainImage})` }}>
        ...
        <div className="right_part">
          <div className="right_in">
            <h3 className="fn__maintitle" data-text={aboutData.title}>
              {aboutData.title}
            </h3>
            ...
            <a
              href={aboutData.discordLink}
              className="metaportal_fn_button"
              target="_blank"
              rel="noreferrer"
            >
              <span>{t("about.findUsOnInstagram")}</span>
            </a>
          </div>
        </div>
      </div>
