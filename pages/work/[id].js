...
import { getNfts, getSingleNft, getWorks } from "../../src/redux/actions/nfts";
      ...
      <div className="metaportal_fn_mintpage">
        <div className="container small">
          ...
          <div className="metaportal_fn_mintbox">
            <div className="mint_left">
              <div className="mint_title">
                <span>{t("singleworks.info")}</span>
              </div>
              <div className="mint_list">
                <ul>
                  <li>
                    <div className="item">
                      <h4>{t("singleworks.number")}</h4>
                      <h3>{nft && nft.id}</h3>
                    </div>
                  </li>
                  <li>
                    <div className="item">
                      <h4>{t("singleworks.collection")}</h4>
                      <h3>{nft && nft.collectionName}</h3>
                    </div>
                  </li>
                  <li>
                    <div className="item">
                      <h4>{t("singleworks.type")}</h4>
                      <div className="qnt">
          ...
          <div className="metaportal_fn_similar">
            <h3 className="fn__maintitle" data-text={t("singleworks.othercollectionworks")}>
              {t("singleworks.othercollectionworks")}
            </h3>
          ...
          {/* Similar Items */}
          <div className="metaportal_fn_similar">
            <h3 className="fn__maintitle" data-text={t("singleworks.similarItems")}>
              {t("singleworks.similarItems")}
            </h3>
            <div className="fn_cs_divider">
              <div className="divider">
                <span />
